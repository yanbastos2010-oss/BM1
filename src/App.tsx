    ...
    <div className="min-h-screen font-sans overflow-x-hidden">
            ...
            >
              ...
              <div className="px-4 pb-4 pt-6 flex flex-col items-center">
                ...
                <p className="text-center text-sm text-gray-600 mb-4 leading-relaxed px-2">
                  Você escolheu o plano básico de <span className="font-bold text-gray-800">R$ 10,00</span>, mas por apenas <span className="font-bold text-[#00C853]">R$ 9,90 a mais</span> pode liberar o Pacote Completo, com acesso total a +250 Dinâmicas para Bombeiros Mirins e todos os bônus.
                </p>
                ...
                <div className="bg-[#F0FDF4] w-full rounded-2xl p-4 mb-4 border border-slate-100 flex flex-col items-center">
                  ...
                  <div className="flex flex-col gap-2.5 w-full">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] sm:text-xs font-black text-gray-900 uppercase">+250 DINÂMICAS PARA BOMBEIROS MIRINS</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="bg-[#00C853] rounded-full p-0.5 flex-shrink-0">
                        <Check className="w-3 h-3 text-white" strokeWidth={4} />
      ...
      <div className="bg-[#D92525] text-white py-2 px-2 sm:px-4 shadow-md relative overflow-hidden">
        <div className="max-w-4xl mx-auto flex items-center justify-center gap-2 sm:gap-4 relative z-10">
          <Flame className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-300 fill-yellow-500 shrink-0" />
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <span className="block sm:hidden text-[2.2rem] leading-[0.95] tracking-[-0.08em] px-0">
              <span className="block whitespace-nowrap"><span style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>+250 Dinâmicas</span> que</span>
              <span className="block whitespace-nowrap">Tornam o programa</span>
              <span className="block whitespace-nowrap">Bombeiros Mirins 3x</span>
              <span className="block whitespace-nowrap"><span style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>Mais Envolvente</span></span>
            </span>
            <span className="hidden sm:inline">
              <span style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>+250 Dinâmicas</span> que Tornam o programa Bombeiros Mirins <span style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>3x Mais Envolvente</span> Para Qualquer Criança
            </span>
          </motion.h1>
          ...
          <img 
            ...
            alt="Mockup" 
            className="w-full max-w-5xl mx-auto drop-shadow-2xl mb-8" 
          ...
          <motion.button 
            ...
            className="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-black py-3 px-8 rounded-full text-base sm:text-xl mb-4 shadow-lg flex items-center justify-center gap-2 mx-auto animate-scale-pulse cursor-pointer"
          >
            👇 Quero Acessar Agora 👇
          </motion.button>
        </div>
      ...
      <section className="bg-white pt-2 pb-6 px-4">
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-3">
          {[
            "Desenvolve Disciplina e Coragem",
            "Prevenção e Primeiros Socorros",
            "Para crianças de 7 a 14 anos",
            "Atividades 100% seguras e lúdicas"
          ].map((feature, i) => (
            <div 
              key={i}
          ...
          <div className="max-w-2xl mx-auto text-center mt-6 mb-4">
            <p className="text-gray-600 text-lg sm:text-xl leading-relaxed">
              Transforme suas aulas e treinamentos em experiências marcantes de <span className="text-[#10B981] font-bold">disciplina, prevenção e cidadania</span> - sem passar horas planejando do zero.
            </p>
          </div>
      ...
      <section className="bg-white py-8 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="space-y-3">
            {[
              "Fica sem ideias de atividades novas para os encontros",
              "Sente que as crianças se dispersam nas aulas teóricas",
              "Tem dificuldade em ensinar prevenção sem assustar",
              "Não encontra dinâmicas seguras para o ambiente do quartel",
              "Termina o dia sentindo que a turma não absorveu o conteúdo"
            ].map((text, i) => (
      ...
      <section className="bg-white pt-0 pb-2 px-4 text-center">
        <div className="max-w-2xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-4">
            Com <span className="text-[#10B981] font-black">DINÂMICAS PRONTAS</span> você vai engajar qualquer criança, ensinar prevenção e primeiros socorros com leveza e formar bombeiros mirins disciplinados e confiantes.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#F0F4F8] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {[
              { title: "Certificado de Conclusão", oldPrice: "27", icon: Award },
              { title: "Quiz Interativo", oldPrice: "33", icon: Gamepad2 },
              { title: "Manual de Prevenção de Incêndios em Casa e Escola", oldPrice: "37", icon: BookOpen }
            ].map((bonus, i) => (
              <div 
                key={i}
                className="bg-white rounded-2xl p-6 border-2 border-orange-500 shadow-sm flex items-start gap-4 transition hover:shadow-md"
              >
                <div className="bg-orange-100 rounded-xl p-3 shrink-0 flex items-center justify-center">
                  <bonus.icon className="w-8 h-8 text-orange-600" />
                </div>
                <div>
      ...
      <section id="pricing" className="bg-white py-12 px-4 relative">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-black text-center text-gray-900 mb-6">Escolha Seu <span style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>Plano</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            ...
            {/* Complete Plan */}
            <div className="bg-orange-50 rounded-3xl shadow-xl border-2 border-orange-500 overflow-hidden relative flex flex-col items-center transform md:-translate-y-4">
              <div className="bg-gradient-to-r from-red-600 to-orange-500 w-full text-center py-1.5 text-white font-black uppercase text-xs flex items-center justify-center gap-1.5">
                <Star className="w-3 h-3 fill-white" /> Mais Escolhido
              </div>
              <div className="p-6 flex flex-col items-center w-full">
                <h3 className="text-xl font-black mb-1 uppercase bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Plano Completo</h3>
                <p className="text-gray-500 text-xs mb-4 text-center">Para transformar suas aulas e treinamentos</p>
                <div className="flex font-black mb-1 items-start bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">
                  <span className="text-lg mt-2">R$</span>
                ...
                <div className="w-full mb-4 text-left">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="text-[#10B981] font-black text-sm sm:text-base leading-tight">+250 Dinâmicas para Bombeiros Mirins:</h4>
                  </div>
                  <ul className="space-y-1 text-gray-700 font-bold text-sm ml-8 list-disc">
                    <li>Prevenção e Primeiros Socorros</li>
                    <li>Disciplina e Cidadania</li>
                    <li>Trabalho em Equipe</li>
                    <li>Atividades Seguras e Lúdicas</li>
                    <li>Ação em Emergências</li>
                  </ul>
                </div>
                ...
                <div className="w-full bg-white rounded-xl p-3 border border-[#DCFCE7] mb-4 text-left">
                  ...
                  <ul className="space-y-1.5 text-gray-600 text-[11px] font-medium">
                    ...
                    <li className="flex items-center gap-2">• Manual de Prevenção de Incêndios em Casa e Escola</li>
                  </ul>
                </div>

                <div className="w-full space-y-3 mb-6 text-left">
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <Users className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Para Aulas e Treinamentos Mirins</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <BookOpen className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Adequado para 7 a 14 Anos</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <Zap className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Aplicação Imediata</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <Calendar className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Atualizações Mensais</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <LockOpen className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Materiais 100% Baixáveis</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <Users className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Suporte Rápido</span>
                  </div>
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm">
                    <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-1 flex-shrink-0">
                      <ShieldCheck className="w-3 h-3 text-white" />
                    </div>
                    <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">Garantia de 7 dias</span>
                  </div>
                </div>
          ...
          {/* Delivery Notice */}
          <div className="mt-8 md:mt-12 bg-white rounded-2xl border-2 border-orange-500 p-4 flex items-center gap-4 shadow-sm max-w-sm mx-auto">
            <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-full p-2 shrink-0">
      ...
      <section className="bg-white py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { name: "Carlos", role: "Instrutor de Bombeiros Mirins", text: "Uso nas aulas com os mirins e mudou bastante a atenção, antes as crianças ficavam muito dispersas", img: "https://i.ibb.co/jvgrT7kz/481325832-1050413120458638-3730499619153101241-n.webp" },
              { name: "Ricardo", role: "Coordenador de Projetos", text: "Eu travava muito pra montar as atividades, agora só abro, escolho e aplico. Facilitou demais!", img: "https://i.ibb.co/k6Wg3hkD/Captura-de-tela-2026-05-09-221515.png", pos: "bottom" },
              { name: "Ana", role: "Instrutora de Bombeiros Mirins", text: "Os encontros aqui ficaram muito melhores, as crianças participam de verdade e aprendem brincando", img: "https://i.ibb.co/gLvjhGH0/Captura-de-tela-2026-05-09-215452.png" }
            ].map((t, i) => (
        ...
        <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.05)] p-6 text-center border border-gray-100">
          <div className="w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-4">
            <div style={{ backgroundImage: 'linear-gradient(to right, #dc2626, #f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              <ShieldCheck className="w-14 h-14" style={{ stroke: 'url(#gradient-shield)' }} />
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "Serve para crianças de qual idade?", a: "As dinâmicas foram pensadas para a faixa etária de 7 a 14 anos, sendo facilmente adaptáveis para os encontros." },
              { q: "Preciso ter experiência para aplicar?", a: "Não, o material é em formato de passo a passo. Qualquer instrutor, bombeiro ou voluntário consegue aplicar facilmente." },
              { q: "As atividades são seguras?", a: "Sim, 100% seguras. Focamos em atividades lúdicas de prevenção, disciplina e cidadania, ideais para o ambiente do projeto." },
              { q: "E se eu não gostar?", a: "Você tem 7 dias de garantia incondicional para testar e, se não gostar, pedir reembolso integral." }
